...
public class Home extends JFrame{
    ...
    Home(){
        ...
        // رسم المستطيل الأول في المصفوفة المحارفية
        RectangleFormatController.drawRectangle(charMatrix, 0, 0, 5, 10, '|');

        // رسم المستطيل الثاني في المصفوفة المحارفية
        RectangleFormatController.drawRectangle(charMatrix, 5, 5, 3, 7, '-');

        // طباعة المصفوفة المحارفية في ملف نصي
        RectangleFormatController.printMatrixToFile(charMatrix, "char_matrix_rectangles.txt");
        ...
        addButton.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                try {
                    ...
                    treeRec.addNode(value,width,height);
